...
:help
 ...
 call :LOGINFO "    '%~0' [КОМАНДА] [ПАРАМЕТРЫ] ..."
 call :LOGINFO " "
 call :LOGINFO "Общие параметры:"
 ...
 call :LOGINFO "    autocommint         - без параметров дедает автокоммит в текущей датой и временим"
 call :LOGINFO "                        - без параметров выводит информацию"
 call :LOGINFO " "
