...
title %MAINTITLE%
rem call :LOGINFO "íÖäìôÖâ äÄíÄãéÉ: '%CD%'"
...
call :LOGINFO "íÖäìôÖâ äÄíÄãéÉ: '!ROOTDIR!'"
...
call :LOGLINE2
call :LOGTEST "èêéÇÖêäÄ èêàëìíëíÇàü Ç äÄíÄãéÉÖ '%CD%' êÖèéáàíéêàü"
if not exist .git (
 if not "%~1" == "gitinit" (
  call :LOGLINE3
  call :LOGWARNING "------------------------------------------------------------------------------------------"
...
call :LOGDEBUG "ÇÖêïçàâ äÄíÄãéÉ: '!PARENTFOLDER!'"
set REPONAME=!PARENTFOLDER!
call :LOGINFO "êÖèéáàíéêàâ REPONAME: '!REPONAME!'"
...
if "%~1" == "gitinit" (
:GITINITL1
 call :LOGINFO "ëéáÑÄçàÖ à àçàñàÄãàáÄñàü êÖèéáàíéêàü Ç äÄíÄãéÉÖ '!ROOTDIR!'"

 if exist .git (
 call :LOGTEST "ìÑÄãàíú íÖäìôàâ êÖèéáàíéêàâ '!REPONAME!' à áÄçéÇé ëéáÑÄíú Y/N"
 ...
 if "!ASK1!"=="y" goto :GITINITL2
 if "!ASK1!"=="Ñ" goto :GITINITL2
 if "!ASK1!"=="§" goto :GITINITL2

 call :LOGWARNING " ------------------------------------------------------------------------------------------"
 call :LOGWARNING " ---                               ÇõïéÑ ÅÖá ìÑÄãÖçàü                                   ---"
 call :LOGWARNING " ------------------------------------------------------------------------------------------"
 ...
 :GITINITL2
  call :LOGWARNING " ------------------------------------------------------------------------------------------"
  call :LOGWARNING " --- ìÑÄãÖçàÖ êÖèéáàíéêàü '!REPONAME!'"
  call :LOGWARNING " ------------------------------------------------------------------------------------------"
  echo . 
...
rem ssh -p 9222 git@192.168.88.12 "cd /mnt/DISK4/1_REPO && ls"
 ...
 call :LOGINFO "ëéáÑÄçàÖ à àçàñàÄãàáÄñàü ìÑÄãÖççéÉé êÖèéáàíéêàü '!REPONAME!' çÄ ëÖêÇÖêÖ '!gitremote!'"
...
:help
 ...
 call :LOGINFO "                          ¢ ™†‚†´Æ£ ™ÆØ®‡„•‚ ¢·• ≠•Æ°ÂÆ§®¨Æ•, "
 call :LOGINFO "                          ØÆ·´• ·Æß§†≠®Ô ¢·• ¢ÎßÆ¢Î ≠†§Æ §•´†‚Ï ®ß folder "
...
:GITAUTOCOMMIT
 ...
 call :LOGINFO2 "ïéëí àåü èéãúáéÇÄíÖãü:           '!hostuser!'"
...
:GITHUBAUTHLOGIN
 ...
 if %ERRORLEVEL% EQU 1 (
  ...
  call :LOGWARNING "------------------------------------------------------------------------------------------"
  call :LOGWARNING " GITHUB „¶• ÄÇíéêàáéÇÄçõ ¢ ·®·‚•¨•"
  call :LOGWARNING "------------------------------------------------------------------------------------------"
 )
...
rem                             ------------------------------------------------------------------------------------------
:LOGLINE0
echo [0m¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ
goto :eof

:LOGLINE1
echo [0m⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø
goto :eof                                                                                                                    
                                                                                                                             
:LOGLINE2                                                                                                                    
echo [0m√ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥
goto :eof                                                                                                                    
...
:LOGLINE3
echo [0m√[95mƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ[0m¥[0m
goto :eof

:LOGLINE4
echo [0m√[93mƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ[0m¥[0m
goto :eof
...
rem [nK EL  - Erase in Line - ì§†´Ô•‚ Á†·‚Ï ·‚‡Æ™®. 
rem 				Ö·´® n ‡†¢≠Æ ≠„´Ó (®´® Æ‚·„‚·‚¢„•‚), ÆÁ®È†•‚ ¢·Ò Æ‚ ™„‡·Æ‡† §Æ ™Æ≠Ê† ·‚‡Æ™®.
rem 				Ö·´® n ‡†¢≠Æ •§®≠®Ê•, ÆÁ®È†•‚ ¢·Ò Æ‚ ™„‡·Æ‡† §Æ ≠†Á†´† ·‚‡Æ™®.
rem 				Ö·´® n ‡†¢≠Æ §¢„¨, ÆÁ®È†•‚ ¢·Ó ·‚‡Æ™„. èÆ´Æ¶•≠®• ™„‡·Æ‡† ≠• ¨•≠Ô•‚·Ô.
rem [nF CPL - Cursor Previous Line - è•‡•¨•È†•‚ ™„‡·Æ‡ ¢ ≠†Á†´Æ n-Æ© (ØÆ „¨Æ´Á†≠®Ó 1-©) ·‚‡Æ™® ·¢•‡Â„ Æ‚≠Æ·®‚•´Ï≠Æ ‚•™„È•©.
rem [nE CNL - Cursor Next Line - è•‡•¨•È†•‚ ™„‡·Æ‡ ¢ ≠†Á†´Æ n-Æ© (ØÆ „¨Æ´Á†≠®Ó 1-©) ·‚‡Æ™® ·≠®ß„ Æ‚≠Æ·®‚•´Ï≠Æ ‚•™„È•©.
