...
call :LOG "áÄèàëú Ç îÄâã '%file_name_ini%'"
...
:CREATEGITHUBOWNER
 ...
 if "%OWNER%" == "" ( 
  call :LOGWARNING "----------------------------------------------------------------------------------------------------"
  call :LOGWARNING " çÖéÅïéÑàåé ìëíÄçéÇàíú ÇÑÄÑÖãúñÄ êÖèéáàíÄêàü Ñãü GitHub èÖêÖÑ áÄèìëäéå 'GIT INIT'"
  call :LOGWARNING " äéåÄçÑéâ 'git config github.name "ÇÑÄÑÖãúñ"' "
  call :LOGWARNING "----------------------------------------------------------------------------------------------------" 
